...
//@desc         GET /api/v1/auth/logout
//@desc         Private
exports.logout = asyncHandler(async (req, res, next) => {
    res.cookie('devcamp_token', 'none', {
...
//@desc         POST /api/v1/auth/updatedetails
//@desc         Private
...
//@desc         POST /api/v1/auth/updatepassword
//@desc         Private
...
exports.forgotPassword = asyncHandler(async (req, res, next) => {
    ...
    if (!user) {
        return next(
            new ErrorResponse(
                'No user found with that email', 400
            )
        );
    }
    ...
    // Create reset url
    const resetlUrl = `${req.protocol}://${req.get(
        'host'
...
//@desc         Reset password
//@desc         POST /api/v1/auth/resetpassword/:resettoken
//@desc         Public
exports.resetPassword = asyncHandler(async (req, res, next) => {
    // Get hashed token
    console.log('here ', req.params.resettoken)
...
const sendTokenResponse = (user, statusCode, res) => {
    ...
    res
        .status(statusCode)
        .cookie('devcamp_token', token, options)
        .json({
            success: true,
            token
        });
